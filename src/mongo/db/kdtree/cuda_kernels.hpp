...
namespace mongo {
	...
	void testKey(int numRecords, uint64_t *dBlockResults, TripKey *dKeys, uint32_t qsize, uint64_t * queryRange, int noRegions, uint32_t* dRegionSize, uint32_t* sRegionOffset, float *dRegions, long *dResults, cudaStream_t dStream);
