...
def generate(env):
        ...
        env['STATICNVCCCMD'] = '$NVCC -o $TARGET $NVCCFLAGS $STATICNVCCFLAGS -c $SOURCES'
        ...
        env.Append(CPPPATH=[cudaSDKPath + '/samples/common/inc', cudaToolkitPath + '/include'])
        env.Append(LIBPATH=[cudaSDKPath + '/lib64', cudaSDKPath + '/common/lib64' + cudaSDKSubLibDir, cudaToolkitPath + '/lib64'])
        env.Append(LIBS=['cudadevrt','cudart'])
        env.Append(NVCCFLAGS=["-I" + cudaSDKPath + '/samples/common/inc', "-I" + cudaToolkitPath + '/include'])
