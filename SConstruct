...
cudaEnv = Environment(BUILD_DIR=variantDir);
cudaEnv.Tool('cuda', './')
cudaEnv['NVCCFLAGS'].append(["-m64", "-gencode", "arch=compute_35,code=sm_35", "-O3", "-use_fast_math"])

env.Append(LIBPATH=[cudaEnv['LIBPATH']], LIBS=[cudaEnv['LIBS']])
